         ...
         <div>
               ...
               <div className="sticky stickybar">
                  <div className="d-flex justify-content-between align-items-center py-2">
                     ...
                     <div className="d-flex justify-content-end">
                        <Link to={NPC_PAGE} className="mr-3">
                           <Button
                              color="success"
            ...
            <Form>
                  ...
                  <Col sm="12" md="6">
                     <FormGroup>
                        ...
                        <Input
                           ...
                           name="armor_class"
                           id="armor_class"
                           placeholder={this.state.npc.armor_class}
                           onChange={this.handleChange}
                        />
                     </FormGroup>
                  </Col>
                  <Col sm="12" md="6">
                     <FormGroup>
                        ...
                        <Input
                           ...
                           id="speed"
                           placeholder={
                              this.state.npc.speed ||
                              'ex. 35ft ground, 40ft flying'
                           }
                           onChange={this.handleChange}
                        />
                     </FormGroup>
                  ...
                  <Col sm="12" md="6">
                     <FormGroup>
                        ...
                        <Input
                           ...
                           name="hit_points"
                           id="hit_points"
                           placeholder={this.state.npc.hit_points}
                           onChange={this.handleChange}
                        />
                     </FormGroup>
                  </Col>
                     ...
                     <FormGroup>
                        ...
                        <Input
                           ...
                           {challengeRatings.map((challenge, i) => {
                              return (
                                 <option key={i}>{challenge.rating} </option>
                              )
                           })}
                        </Input>
                     </FormGroup>
                     ...
                     <Col sm="12" md="6">
                        <FormGroup>
                           ...
                           <Input
                              ...
                              name="strength"
                              id="strength"
                              placeholder={this.state.npc.strength}
                              onChange={this.handleChange}
                           />
                        </FormGroup>
                        <FormGroup>
                           ...
                           <Input
                              ...
                              name="dexterity"
                              id="dexterity"
                              placeholder={this.state.npc.dexterity}
                              onChange={this.handleChange}
                           />
                        </FormGroup>
                        <FormGroup>
                           ...
                           <Input
                              ...
                              name="constitution"
                              id="constitution"
                              placeholder={this.state.npc.constitution}
                              onChange={this.handleChange}
                           />
                        </FormGroup>
                     </Col>
                     <Col sm="12" md="6">
                        <FormGroup>
                           ...
                           <Input
                              ...
                              name="wisdom"
                              id="wisdom"
                              placeholder={this.state.npc.wisdom}
                              onChange={this.handleChange}
                           />
                        </FormGroup>
                        <FormGroup>
                           ...
                           <Input
                              ...
                              name="intellect"
                              id="intellect"
                              placeholder={this.state.npc.intelligence}
                              onChange={this.handleChange}
                           />
                        </FormGroup>
                        <FormGroup>
                           ...
                           <Input
                              ...
                              name="charisma"
                              id="charisma"
                              placeholder={this.state.npc.charisma}
                              onChange={this.handleChange}
                           />
                        </FormGroup>
                     </Col>
               ...
               <Row>
                  ...
                  <Col sm="12" md="6">
                     <FormGroup>
                        <Label for="condition_immunities">
               ...
               <Row className="mb-2">
                  <Col sm="12" md="6">
                     <NpcSavingThrows
                        className="mt-4"
                        listener={this.handleSpecialChange}
...
export default withSizes(mapSizesToProps)(NpcForm)
