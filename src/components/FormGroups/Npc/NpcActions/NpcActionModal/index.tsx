...
/** NpcActionModal -  Component is used for both creating and editing actions. */

export default class NpcActionModal extends Component<Props> {
  state = {
    ...this.props.action
  };
    ...
    return (
      <div className="p-3">
        ...
        <Row className="mt-2">
          ...
          <Col sm="12" md="4">
            <FormGroup>
              <Label className="font-weight-lighter" for="average_damage">
                Average Damage
              </Label>
              <Input
                type="number"
        ...
        <Row className="mt-2">
          <Col sm="12" md="4">
            <FormGroup>
              <Label className="font-weight-lighter" for="bonus_damage_dice">
                Bonus Damage Dice
              </Label>
              <Input
                type="text"
          ...
          <Col sm="12" md="4">
            <FormGroup>
              <Label className="font-weight-lighter" for="average_damage_bonus">
          ...
          <Col sm="12" md="4">
            <FormGroup>
              <Label className="font-weight-lighter" for="bonus_damage_type">
                Bonus Damage Type
              </Label>
              <Input
                type="select"
